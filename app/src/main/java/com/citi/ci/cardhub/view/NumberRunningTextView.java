...
import com.citi.ci.cardhub.utils.StringUtils;
...
public class NumberRunningTextView extends AppCompatTextView {
    ...
    public NumberRunningTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        minNum = ta.getInt(R.styleable.NumberRunningTextView_minNum, 0);
        minMoney = ta.getFloat(R.styleable.NumberRunningTextView_minMoney,0.0f);
    ...
    public void playMoneyAnim(String moneyStr) {
        ...
        try {
            ...
            if (finalFloat <= minMoney) {
                ...
                Logger.e("Num===00");
                floatAnimator =  ValueAnimator.ofFloat(845.00f, finalFloat);
//                setText(moneyStr);
//                return;
            }else {
                 floatAnimator = ValueAnimator.ofFloat(0, finalFloat);
            }
